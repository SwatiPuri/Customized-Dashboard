...
export class WidgetOneComponent{
  ...
  ip :string;
  port:string;
    droneApis =["Drone Orientation","Drone ENU Position","Drone GPS State","Drone Flight State",
              "Drone Flight Mode","Drone Flight Time","Service Info","Drone Basic Info","Drone Battery Info",
              "Drone License Info","Drone Payload Info","Drone Battery State","Drone GPS Position","Drone Battery Level",
              "Camera Orientation"
]
